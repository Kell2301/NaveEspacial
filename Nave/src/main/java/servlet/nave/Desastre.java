...
public class Desastre {
    ...
    public Familia[][] fugaDeAire (Familia[][] nave, int tickMuerte){
        ...
        */
        ...
        personas.get(tresMasViejos[0][2]).setCausaMuerte("Fuga de aire");
        ...
        personas.get(tresMasViejos[1][2]).setCausaMuerte("Fuga de aire");
        ...
        personas.get(tresMasViejos[2][2]).setCausaMuerte("Fuga de aire");
        ...
        do {
            ...
            if (estadoFamilia) {
                for (int i = 0; i < nave[posicionFila][posicionColumna].getFamilia().size(); i++) {
                    nave[posicionFila][posicionColumna].getFamilia().get(i).setCausaMuerte("Locura");
